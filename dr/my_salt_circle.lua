...
--- name: my_salt_circle
--- version: 1.0
--- author: Raelok/Kalros/Haldrik/Melduran
--- game: dr
--- description: Salt circle variant with safe cooldown check.
--- tags: necromancer, salt, ritual
---
--- Converted from my-salt-circle.lic

local last_circle = UserVars.salt_circle
if last_circle then
